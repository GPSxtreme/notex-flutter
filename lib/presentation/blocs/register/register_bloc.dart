...
class RegisterBloc extends Bloc<RegisterEvent, RegisterState> {
  ...
  FutureOr<void> processRegisterUser(RegisterPageRegisterButtonPressedEvent event, Emitter<RegisterState> emit) async{
    try{
  ...
  FutureOr<void> processRedirectToLoginPage(RegisterPageLoginButtonPressedEvent event, Emitter<RegisterState> emit) {
  emit(RegisterRedirectToLoginState());
  }
  FutureOr<void> processEmptyCredentialsError(RegisterPageEmptyCredentialsEvent event, Emitter<RegisterState> emit) {
    emit(RegisterEmptyCredentialsState());
  }
  FutureOr<void> processPasswordsDoNotMatchError(RegisterPagePasswordsDoNotMatchEvent event, Emitter<RegisterState> emit) {
